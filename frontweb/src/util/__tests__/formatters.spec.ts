...
describe('formatPrice for positive numbers', () => {
  ...
  test('formatPrice should format number pt_BR when given 0.1', () => {
...
describe('formatPrice for non-positive numbers', () => {
    test('formatPrice should format number pt_BR when given 0', () => {
      const result = formatPrice(0);
      expect(result).toEqual('0,00');
    });
  
    test('formatPrice should format number pt_BR when given -5.1', () => {
